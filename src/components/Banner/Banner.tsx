...
const Banner: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="container hidden bg-white lg:flex lg:flex-col mx-auto mt-10">
              ...
              {tabs.map((tab) => (
                <li
                  ...
                  className={`cursor-pointer p-2 ${
                    activeTab === tab
                      ? "bg-blue-200 text-[#1C1C1C] font-medium rounded-lg"
                      : "text-gray-600"
                  }`}
          ...
          <aside className="w-full md:w-1/5 p-4 flex flex-col gap-4">
            ...
            <div className="bg-[#F38332] text-white p-4 rounded-lg">
              <p className="flex flex-col">
                <span>Get US $10 off</span> <span>with a new</span> supplier
              </p>
            </div>
            <div className="bg-[#55BDC3] text-white p-4 rounded-lg">
              <p className="flex flex-col">
                <span>Send quotes with</span> <span>supplier</span> preferences
              </p>
            </div>
          </aside>
        </div>
