          ...
          {products.map((product, index) => (
            ...
            >
              ...
              >
                ...
                <div className="p-4">
                  {!isGrid ? (
                    <div className="flex items-center justify-between gap-2 lg:w-[30rem]">
                      <h2 className="text-lg font-bold">{product?.name}</h2>
                      <FaRegHeart className="text-[#0D6EFD] text-5xl lg:text-4xl rounded-lg border px-1 lg:p-2" />
                    </div>
                  ) : (
                    ""
                  )}
                  <div className="flex md:flex-row gap-2 flex-col justify-between">
                    <div>
                      ...
                      >
                        ...
                        {isGrid ? (
                          <FaRegHeart className="text-[#0D6EFD] text-4xl rounded-lg border p-2" />
                        ) : (
                          ""
                        )}
                      </p>
                  ...
                  {isGrid ? (
                    <h2 className="text-lg text-[#606060]">{product?.name}</h2>
                  ) : (
                    ""
                  )}
                </div>
